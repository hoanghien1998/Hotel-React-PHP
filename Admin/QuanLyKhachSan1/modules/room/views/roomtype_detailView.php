...
//                            echo $num_row_room_code;
                            ...
                            <fieldset>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" name="roomtypedetailBed" placeholder="" value="<?php if (isset($roomtypedetail)) echo $roomtypedetail['giuong'] ?>" class="form-control">
                                </div>
                                    ...
                                    <ul>
                                        ...
                                        if (!empty($roomtypedetail_img)) {
                                            foreach ($roomtypedetail_img as $img) {
                                                ?>
                                                <li class="col-md-4">
                                                    <img class="roomtypedetail_image" src="http://localhost:8081/Pro_Hotel/Admin/QuanLyKhachSan1/public/images/room/<?php echo $img['image']; ?>"/>
