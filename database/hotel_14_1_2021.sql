...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 14, 2021 lúc 02:47 AM
...
(2, 'Hien Hoang Thi', '', '', '', '17110411@student.hcmute.edu.vn', '', ''),
...
(1, 1, 1, 1500000, 5, 1, 0, '2021-01-18', '2021-01-22', '2021-01-13');
...
(1, 'Phòng Hoàng Gia với sân hiên', 1500000, 'room-1.jpg'),
(2, 'Phòng Thương Gia hướng biển', 1300000, 'room-2.jpg'),
(3, 'Phòng Hoàng Gia hướng biển', 1200000, 'room-3.jpg'),
(4, 'Phòng đơn view hướng biển', 800000, 'room-4.jpg'),
(5, 'Phòng đơn hướng biển', 500000, 'room-5.jpg'),
(6, 'Phòng đôi hướng biển', 900000, 'room-6.jpg');
...
--
ALTER TABLE `customer`
  MODIFY `cus_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
